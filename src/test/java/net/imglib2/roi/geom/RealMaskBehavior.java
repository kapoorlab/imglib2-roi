...
public class RealMaskBehavior
{
	...
	{
		final Box< RealPoint > rect = new OpenBox(
				new double[] { 10, 20, 30 },
		...
		final SuperEllipsoid< RealPoint > ellipse = new ClosedSuperEllipsoid(
	...
	{
		final Polygon2D< RealPoint > polygon = new ClosedPolygon2D(
				x,
				y );
